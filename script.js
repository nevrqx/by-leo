...
// Override/Wrap loadVocabulary to intercept data for quiz
const originalLoadVocabulary = window.loadVocabulary;
window.loadVocabulary = function (title, words) {
    if (VocabularyQuiz.state.isLoading) {
        VocabularyQuiz.collectWords(words);
    } else {
        originalLoadVocabulary(title, words);
    }
};
